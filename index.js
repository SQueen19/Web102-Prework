...
// later, we will call this function using a different list of games
...
const displayStr = `A total of $${totalContributions.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedCount} ` +
    `${unfundedCount !== 1 ? "games remain" : "game remains"} unfunded. We need your help to fund these amazing games!`;
...
firstGameElement.innerText = first.name;
firstGameContainer.append(firstGameElement);
// do the same for the runner up item
const secondGameElement = document.createElement('p');
secondGameElement.innerText = second.name;
